...
public class Main {
    ...
    public static int getNumberOfSubBreeds(String breed, BreedFetcher breedFetcher) {
        ...
        try {
            // The call to getSubBreeds now requires a try-catch block
            // because BreedNotFoundException is a checked exception.
            ...
            // If the fetcher throws a BreedNotFoundException, return zero as per documentation.
            return 0;
        }
    }
}